...
final class SyncClassificationToMongoJob implements ShouldQueue
{
    ...
    {
        $mongo->upsert('classifications', $this->document['id'], $this->document);
    }

    public function failed(\Throwable $exception): void
    {
        Log::error('SyncClassificationToMongoJob falló permanentemente', [
            'classification_id' => $this->document['id'],
