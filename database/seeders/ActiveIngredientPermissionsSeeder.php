...
final class ActiveIngredientPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        $permission = Permission::firstOrCreate([
            'name' => 'catalog.active-ingredients.manage',
            'guard_name' => 'api',
        ]);
        ...
        $this->command->info('✔ catalog.active-ingredients.manage creado y asignado.');
    }
}
